...
Copy all your work of the [0x06. Basic authentication](https://github.com/dianaparr/holbertonschool-web_back_end/tree/main/0x06-Basic_authentication) project in this new folder.
...
- Overload `def create_session(self, user_id=None):` that creates and stores new instance of `UserSessio`n and returns the Session ID
